...
class yii2fullcalendar6 extends elWidget
{
    ...
    */
    ...
    public function init()
    {
        ...
        if (!isset($this->clientOptions['schedulerLicenseKey'])) {
            $this->clientOptions['schedulerLicenseKey'] = $this->schedulerLicenseKey;
        }
    ...
    protected function registerPlugin()
    {
        ...
        $js[] = "new FullCalendar.Calendar($id,$clientOptions).render();";
